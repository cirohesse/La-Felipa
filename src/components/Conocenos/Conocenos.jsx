    ...
    <div className={classes.conocenos}>
      <div className={classes.conocenosContainer}>
        <div className={classes.conocenosText}>
          ...
          <p className={classes.intro}>Queremos contarte la historia que guarda nuestras cabañas</p>

          <p>
            Mucho tiempo atrás, habitaba en el encantador pueblo de la Cumbrecita, una mujer ilustre
            que se destacaba por su profunda conexión con la cultura criolla y su excepcional
            habilidad en el tejido con telar. Una gran artesana, guardiana de su tradición en la
            región.
          </p>
